...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add confetti to all buttons with class 'btn-primary'
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Age Calculator specific logic (moved here to avoid conflict with general button listener)
    const birthDateInput = document.getElementById('dobInput');
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 // Changed from ₹ to $ as per your request
};
...
function convertCurrency() {
    ...
    const symbol = currencySymbols[toCurrency] || ''; // Get symbol, default to empty if not found
    convertedAmountSpan.textContent = `${symbol} ${convertedAmount.toFixed(2)}`;
}
